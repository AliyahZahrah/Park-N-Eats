...
class TicketOnly3Page extends StatefulWidget {
  const TicketOnly3Page({super.key});

  @override
  _TicketOnly3PageState createState() => _TicketOnly3PageState();
}

class _TicketOnly3PageState extends State<TicketOnly3Page>
      ...
      if (currentBalance >= totalPrice) {
        ...
        if (updateResponse.statusCode == 200) {
          ...
          await _savePurchaseHistory(
            email,
            '$_selectedTickets Ticket Jatim Park 3',
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Jalan Raya Ir. Soekarno No.144, Beji, Kota Batu, Jawa Timur',
