...
class TicketOnlyPage extends StatefulWidget {
  const TicketOnlyPage({super.key});

  @override
  _TicketOnlyPageState createState() => _TicketOnlyPageState();
}

class _TicketOnlyPageState extends State<TicketOnlyPage>
      ...
      if (currentBalance >= totalPrice) {
        ...
        if (updateResponse.statusCode == 200) {
          ...
          await _savePurchaseHistory(
            email,
            '$_selectedTickets Ticket Jatim Park 1',
